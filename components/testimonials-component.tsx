  ...
  return (
    <div className="min-h-screen bg-background py-20">
      <div className="container mx-auto px-4">
        ...
        {/* CTA Section */}
        <div className="text-center bg-black rounded-2xl p-8 md:p-12 text-white border-2 border-gray-800">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-3 bg-white text-black rounded-full font-semibold hover:bg-gray-100 transition-colors border-2 border-gray-200">
              Start Your Project
            </button>
