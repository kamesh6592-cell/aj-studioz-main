...
export default function RotatingGradientRight() {
  return (
    <section className="w-full bg-white dark:bg-black text-black dark:text-white px-8 py-16 md:px-16">
      <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
          ...
          <Card className="w-[340px] z-10 rounded-2xl border border-white/10 bg-black/85 shadow-2xl backdrop-blur-xl">
            <CardContent className="p-5">
              <div className="mb-3 flex items-center justify-between">
                ...
                <span className="text-xs text-zinc-400">94 / 100</span>
              </div>

              {/* Progress bar */}
              <div className="mb-3 h-1.5 w-full overflow-hidden rounded-full bg-white/10">
                <div className="h-full w-[94%] rounded-full
                                bg-[linear-gradient(90deg,theme(colors.cyan.400),theme(colors.sky.400),theme(colors.emerald.400))]" />
              </div>

              <p className="text-xs text-zinc-400">
                Training neural networks… optimizing conversation patterns and response accuracy.
              </p>
        ...
        {/* RIGHT: AI Features Content */}
        <div className="space-y-4">
          <h2 className="text-lg sm:text-xl lg:text-3xl font-normal text-gray-900 dark:text-white leading-relaxed">
            AI-Powered Features {" "}
            <span className="text-gray-500 dark:text-gray-400 text-sm sm:text-base lg:text-3xl">Experience intelligent conversations with advanced natural language processing, real-time responses, and seamless integration.</span>
          </h2>
